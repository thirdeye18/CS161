...
//function prototypes for the three helper functions
std::vector <int> frequencyVector (userNumbers, int);
int highestFrequency (userNumbers, int);
...
std::vector <int> frequencyVector (userNumbers numbersIn, 
int size)
{
...
int highestFrequency (userNumbers numbersIn, int size)
{
...
std::vector <int> findMode (userNumbers numbersIn, int size)
{	
